...
description: "The steps you need to follow to use efficiently the application frontendchecklist.io"
...
<!-- ![A screenshot of the HEAD section on frontendchecklist.io](./images/start-to-check.jpg) -->
...
<!-- ![A screenshot of the print version of frontendchecklist.io](./images/validate-before-qa.jpg) -->
