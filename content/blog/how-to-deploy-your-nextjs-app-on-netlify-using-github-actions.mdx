...
description: "Are you interested in Next.js and how to deploy your app to Netlify using Github Actions? Take a look at how Netlify allows you for free, to deploy your app with Server Side Rendering capabilities and more!."
category: Coding
tags:
  - Netlify
  - Github Actions
...
*(For those you are new to coding, feel free to [follow these steps](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/creating-a-new-repository) to create a new repository on Github.)*
...
![Connect to an existing directory or create and configure a new site](https://dev-to-uploads.s3.amazonaws.com/i/3lfvvphd22o7itwliymi.jpg)

Then you have to choose your **team**:

![Question about the name of the team](https://dev-to-uploads.s3.amazonaws.com/i/o2pxn7nwxd8bsxe440vy.jpg)

Choose the **name of your application**:

![Screenshot of the CLI asking for the name of your application](https://dev-to-uploads.s3.amazonaws.com/i/iaih9331d9wzvyxun64e.jpg)
...
![Screenshot of the CLI with the build, start and function script command suggestion](https://dev-to-uploads.s3.amazonaws.com/i/0bl7dmlmnq91fam6cnfy.jpg)
...
![Screenshot of the CLI asking to create a netlify.toml file](https://dev-to-uploads.s3.amazonaws.com/i/gjeo2l0ojuqu3papjrcy.jpg)

Once you provided an answer to all the questions, your terminal should look like this:

![Screenshot of the CLI after all the questions are answered](https://dev-to-uploads.s3.amazonaws.com/i/lmupvfb8aj5n17rl6nyk.jpg)
...
![Screenshot of the Netlify project created](https://dev-to-uploads.s3.amazonaws.com/i/dw42yr8q0qg5tnau04b9.jpg)
...
![Screenshot of the Build settings on Netlify](https://dev-to-uploads.s3.amazonaws.com/i/uzlpzxz6jnixwxdtwbsf.jpg)

Just below, go to the `Deploy contexts` section and select `None` for the Deploy previews.

![Screenshot of the Deploy context section on Netlify](https://dev-to-uploads.s3.amazonaws.com/i/wb9npfwim3m3huk6sfmi.jpg)
...
*(In case you are not interested in Github Actions and want to use Netlify to build your project, take a look at how to use the [Next on Netlify Plugin](https://github.com/netlify/netlify-plugin-nextjs). It directly wraps your Next.js app and doesn't need as much configuration as we are going to explain.)*
...
![Screenshot of the Actions secrets page on Github](https://dev-to-uploads.s3.amazonaws.com/i/nhyz9ipggiss8l2pfw4w.jpg)
...
8. ***Build your project***. Remember that after the build, the post-build command will be launch. This is what you should see in the `build` logs in your Github Action tab:
![Screenshot of the build-in Github Action](https://dev-to-uploads.s3.amazonaws.com/i/vgv3g9u9wuo1besc5v2d.jpg)
...
![Screenshot of all Github actions](https://dev-to-uploads.s3.amazonaws.com/i/n6i27u3pwq1l3am12u8n.jpg)
...
![Screenshot of the Deploy page on Netlify](https://dev-to-uploads.s3.amazonaws.com/i/d0f20hzeayxu0hnqt6ry.jpg)
...
![Screenshot of the PR on Github specifying the link to the logs and preview deploy URL](https://dev-to-uploads.s3.amazonaws.com/i/4m7fz8scb7knsclnb5cj.jpg)

## Summary

![Rocky Balboa pulling with his arms towards the sky like a winner](https://media.giphy.com/media/yoJC2JaiEMoxIhQhY4/giphy.gif)
