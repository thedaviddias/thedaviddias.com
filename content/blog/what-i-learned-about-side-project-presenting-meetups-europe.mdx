...
description: "An overview of what I learned presenting the Front-End Checklist during my vacations in Europe"
canonical: https://www.freecodecamp.org/news/8-things-i-learned-doing-presentations-in-europe-about-the-front-end-checklist-c37ac18e3b4f/
...
![Map showing Spain and Portugal and a line linking Barcelona to Madrid and Porto](./images/map-front-end-checklist-conference.png 'Barcelona, Madrid and Porto')


Knowing that I would be on `holiday` for few weeks in France, Spain, and Portugal I decided to try contacting local groups in **Barcelona, Madrid, Lisbon, Aveiro, and Porto**. I sent messages directly to the founders of local groups using [Meetup.com](https://www.meetup.com/), or contacted them via Twitter when they had specified their account on their profile. But, as I was expecting, I didn’t receive a lot of replies at first.
...
![Event page on the Porto Codes Meetup page](./images/meetup-front-end-checklist-madrid.jpeg)
...
![David Dias standing front of a slide showing a list of JS task runners (Grunt, Gulp, Webpack...)](./images/talking-about-task-runners.jpeg 'Talking about task runners at Ironhack Madrid')
...
<script async class="speakerdeck-embed" data-id="fae83093875444efae3a0894d6815771" data-ratio="1.77777777777778" src="//speakerdeck.com/assets/embed.js"></script>
