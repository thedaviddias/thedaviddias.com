...
export const Header = () => {
  ...
  return (
    <header className="flex-grow-0 flex-shrink-0 main-header dark:text-gray-200 z-30 bg-white dark:bg-gray-900 transition-colors duration-200 py-6 w-full mx-auto sticky top-0 mb-12">
